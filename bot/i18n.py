...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "combat_countdown_edit": "{icon} {character}'s turn — Round {round}\n`[{bar}] {remaining}s`",
        "combat_turn_time_expired": "⏰ *Turn time expired!*\n🎯 {character}'s turn — moving to next.",
        "combat_time_expired_alt": "⏰ Time's up!\n🎯 {character}'s turn — moving to next.",
        "image_campaign_closure": "🎭 *Campaign Complete*\n{name}",
        ...
        "settings_tone_serious": "😑 Serious",
        "settings_tone_funny": "😄 Funny",
        "settings_tone_dark": "🪶 Dark",
        "settings_tone_epic": "⚔️ Epic",
        "settings_lang_es": "🇪🇸 Español",
        "settings_lang_pt": "🇧🇷 Português",
        "settings_lang_en": "🇬🇧 English",
        "settings_img_on": "✅ Enabled (Pollinations)",
        "settings_img_off": "❌ Disabled",
        "settings_yes": "Yes",
        "settings_no": "No",
    ...
    "es": {
        ...
        "combat_countdown_edit": "{icon} Turno de *{character}* — Round {round}\n`[{bar}] {remaining}s`",
        "combat_turn_time_expired": "⏰ *¡Tiempo de turno agotado!*\n🎯 Turno de *{character}* — pasando al siguiente.",
        "combat_time_expired_alt": "⏰ ¡Tiempo agotado!\n🎯 Turno de *{character}* — pasando al siguiente.",
        "image_campaign_closure": "🎭 *Campaña completada*\n{name}",
        "combat_need_two": "⚠️ Need at least 2 combatants to start combat.",
        ...
        "settings_diff_easy": "🟢 Fácil",
        "settings_diff_normal": "🟡 Normal",
        "settings_diff_hard": "🔴 Difícil",
        "settings_tone_serious": "😑 Serio",
        "settings_tone_funny": "😄 Cómico",
        "settings_tone_dark": "🪶 Siniestro",
        "settings_tone_epic": "⚔️ Épico",
        "settings_lang_es": "🇪🇸 Español",
        "settings_lang_pt": "🇧🇷 Português",
        "settings_lang_en": "🇬🇧 English",
        "settings_img_on": "✅ Activada (Pollinations)",
        "settings_img_off": "❌ Desactivada",
        "settings_yes": "Sí",
        "settings_no": "No",
